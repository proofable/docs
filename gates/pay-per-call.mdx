...
Four endpoints accept per-call payment:

| Resource | Method | What it does | Base cost |
|----------|--------|--------------|-----------|
| `/api/v1/proofs/check` | GET | Evaluate existing proofs by address, `gateId`, or verifier filters | 1 credit ($0.0025) |
| `/api/v1/proofs/check` | POST | Evaluate an inline Gate Policy (`defineGate`) against a subject | 1 credit ($0.0025) |
