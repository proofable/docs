...
Pro adds only the four tools needed to run and manage jobs. Product connections, research, model settings, sandbox execution, and private session notes stay in the Proofable app.
