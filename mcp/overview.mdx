...
Interactive hosts use OAuth. For servers, CI, and headless agents, send a Profile access key as a Bearer token instead — see [Connect Proofable](./setup).
...
Then ask the new client to load your agents:
...
**Private cloud.** Point the runtime at the same URL. [Run Proofable in a private cloud](../deployment/private-cloud).
