...
Connect Proofable once. Supported AI clients can then read your profile, agents, approved tools, selected context, permissions, jobs, and current proofs, and check who controls an agent and what it may do before sensitive work.
