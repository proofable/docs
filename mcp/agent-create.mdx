...
**`agentWallet: "generate"`** creates a separate spend account and returns the private key once. Store it in Vault with **`proofable_secret_create`** before you continue.
