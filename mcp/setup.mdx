...
description: "Connect Claude, Cursor, Codex, or another MCP client to Proofable in about a minute, then check agent permissions and reuse proofs."
icon: plug
---

Proofable MCP connects supported chats, IDEs, jobs, and agent runtimes to one profile. Your agents, permissions, and proofs come with you to each client, so you set them up once.
