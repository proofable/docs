---
title: "Carry what's trusted"
sidebarTitle: "Connections"
description: "The same proofs and limits in the next app or client."
icon: plug
---

Stop re-explaining yourself. Link an app once. The next tool uses the same approved connection.
...
| Your assistant | [Add Proofable to any MCP client](/mcp/setup), then open Connections when the work needs an app. |
