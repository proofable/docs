...
| Private cloud | Point the runtime at the same MCP URL. [Run Proofable in a private cloud](./private-cloud-agents) |
...
**Next:** [Agents](../agents/overview) and [MCP setup](../mcp/setup)
