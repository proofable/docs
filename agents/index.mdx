...
title: Agents
sidebarTitle: Agents
description: Bring the agent you already use. Give it a known owner, the context and tools it needs, and limits that supported runtimes can check.
icon: robot
"og:image": "/images/og-agents.png"
"twitter:image": "/images/og-agents.png"
---

Bring the agent you already use. Give it a known owner, the tools and context it needs, and clear limits: allowed actions, spend, expiry, and revocation. Supported runtimes can check that authority before a protected action.
...
Keep your model, runtime, Okta, or enterprise sign-in. Proofable keeps the agent identity, approved stack, current authority, and proofs available to supported clients.
