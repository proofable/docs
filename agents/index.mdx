...
title: "Agents"
sidebarTitle: "Agents"
description: "One owner, infinite agents. Verified identity, scoped permissions, portable context, and proof that compounds in one agent registry."
icon: robot
...
- **Any MCP client.** Cursor, Claude Code, Codex, and VS Code are shortcuts. Load the same agent with `npx -y @proofable/sdk mount <agentId> --apply cursor`.
