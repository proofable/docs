---
title: "Access keys"
description: "Connect servers, CI, scheduled jobs, containers, and headless agents to Proofable with a server key instead of browser sign-in."
icon: key
---

Interactive clients sign in with OAuth. Anything that cannot open a browser authenticates with a key instead. Both reach the same endpoint and the same Proofable profile.
...
<CardGroup cols={2}>
  ...
  <Card title="Add Proofable to any MCP client" icon="plug" href="/mcp/setup">
