---
title: "Put the same check in your product"
sidebarTitle: "Your product"
description: "Run Proofable checks inside your own product with the SDK, so your server makes the final access decision."
icon: layer-group
---
