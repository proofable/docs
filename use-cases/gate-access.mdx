...
<Steps>
  <Step title="Publish a listing">
    Sign in at [proofable.me](https://proofable.me), open **Listings** in your profile, choose what to verify, and set a price or keep it free. Publish, then copy the `gateId`.
  </Step>
