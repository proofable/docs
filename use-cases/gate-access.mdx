...
title: "Gate anything"
sidebarTitle: "Gate"
description: "Require proof before a page, checkout, API, or action."
icon: door-closed
---

Require proof before a page, checkout, API call, or agent action. People reuse proofs they already hold and verify only what is missing. Publish a listing for a saved `gateId`, price, or schedule. Field reference: [Gates](/gates).
