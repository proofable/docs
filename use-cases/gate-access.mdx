...
A gate is a policy over proof. Define the checks in your product. People reuse proofs they already hold and verify only what is missing. Publish a listing only when you want a persisted `gateId`, price, or schedule.
...
Your app can sponsor usage. Users can pay through a Listing. Agents and APIs can pay per call with x402. [Pricing](/pricing)
