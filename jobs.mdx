---
title: "Jobs"
description: "Run agent work on a schedule or in the background without widening what the agent is allowed to do."
icon: clock
---
...
Jobs are included with [Pro](/pricing). Chat with hosted AI and bringing your own model key are available on every plan.

## Hosted AI tiers

| Tier | Plan | Credit rate |
|---|---|---|
| Default | Every plan | 1x |
| Advanced | Pro | 2x |

Bring your own model key and the credit rate stays 1x on any plan. [Pricing](/pricing)
...
| Every | On an interval of minutes, hours, or days, at least 15 minutes apart |
...
Through MCP, Pro exposes the same four job actions: `proofable_job_create`, `proofable_job_list`, `proofable_job_get`, and `proofable_job_cancel`. Other app tools stay on proofable.me.
