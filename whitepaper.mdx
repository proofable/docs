...
description: "How a verification result becomes a portable proof another app can check, and what the format guarantees."
icon: book-open
sidebarTitle: Whitepaper
---

## Verification results that can be reused
