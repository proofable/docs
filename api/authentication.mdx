...
For backend-created proofs after a user approves your product once, see [Server integrations](../integrations/server). Separate from creating a **listing** under profile → **Listings**, which bills hosted verification to your account.
