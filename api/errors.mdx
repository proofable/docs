---
title: API errors
description: "Every Proofable API error code explained: what triggers it, what the response body means, and the exact recovery step for each case."
icon: bug
---
...
| `INSUFFICIENT_CREDITS` | The account paying needs more credits | Add credits, or pay the call with x402 and retry |
| `PAYMENT_ALREADY_USED` | A payment was already bound to this gate or proof | Do not reuse payment evidence across checkouts |
...
| 400 | Bad request |
| 401 | Unauthorized |
| 402 | Payment required. The response carries a quote; add credits or pay the call with x402 and retry |
| 403 | Forbidden |
| 404 | Not found |
| 429 | Rate limited |
| 500 | Server error |
