...
| ACP | Client to a coding harness | Optional self-hosted job pin (OpenCode, Hermes, Claude ACP). Hosted jobs use the Operator engine. Proofable does not spawn ACP on Azure | Works with | [Private cloud agents](/deployment/private-cloud) |
