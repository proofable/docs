---
title: Hosted sign-in and verification
sidebarTitle: Hosted verification
...
Wallet steps appear only when a published gate requires them. Sign-in and gate checkout share one surface.
...
|--|----------------|---------------------------------------------------------------------|
| Purpose | Proofable **session** (profile and later proofs) | **Proof** / listing outcome |
...
Server-created proofs and access keys: [Server integrations](/integrations/server).
