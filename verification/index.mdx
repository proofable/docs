---
title: "Verify"
description: "Every check Proofable can run, what each one proves, and whether you call it interactively or as a lookup."
icon: badge-check
"og:image": "/images/og-verification.png"
"twitter:image": "/images/og-verification.png"
---

Pick the check that matches your decision. Once it passes, the result is saved as proof, and the next decision reads that proof instead of asking again.
