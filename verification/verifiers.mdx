...
description: "Choose the right Proofable verifier for the decision your product makes: identity, ownership, access, or safety. Full catalog."
icon: list-tree
---
...
Ready-made `?preset=` bundles, or combine verifiers with `?verifiers=id1,id2`. See [Presets](./presets).
...
<CardGroup cols={2}>
 <Card title="Sell access" icon="rocket" href="../gates/sell-access">
 First proof.
 </Card>
 <Card title="Hosted Verify" icon="key" href="./hosted">
 Guided.
 </Card>
