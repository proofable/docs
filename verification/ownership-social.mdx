...
sidebarTitle: Social
description: "Confirm control of a social account, then reuse the verified result at every gate. Buyers prove identity without oversharing."
icon: share-nodes
---
...
Full schema: [`ownership-social.json`](https://github.com/proofable/docs/blob/main/verifiers/schemas/ownership-social.json).
