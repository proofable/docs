...
Visibility: private, unlisted, or public. [Security](../security).
...
To store the exact string on the proof, set **`storeOriginalContent: true`** when you need to override defaults. Read back with **`proof.publicContent.content`**. [Security](../security) covers defaults.
