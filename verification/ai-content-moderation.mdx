...
description: "Screen user text or images for unsafe content before you publish, grant access, or let an agent act. Reusable results across surfaces."
...
Full schema: [`ai-content-moderation.json`](https://github.com/proofable/docs/blob/main/verifiers/schemas/ai-content-moderation.json).
