...
See also: [Domain verification cookbook](../cookbook/domain-verification), [JSON Schema](https://github.com/proofable/docs/blob/main/verifiers/schemas/ownership-dns-txt.json).
