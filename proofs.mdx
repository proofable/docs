---
title: "Proofs"
description: "Create, reuse, and share verifiable proof instead of checking twice."
icon: shield-check
---

A proof is the saved result of a completed check, permission, or action. Keep the receipt, then read its current status whenever a decision depends on it.
