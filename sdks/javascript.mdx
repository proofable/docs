...
| Layer | Use |
|-------|-----|
| Browser | **`VerifyGate`** or **Hosted Verify** for missing interactive checks ([Hosted sign-in](../verification/hosted)) |
| Server | **`defineGate`** + **`gateCheck`** for the final decision; advanced: **`verifyFromApp`**, access keys |
